...
const AGENTS: AgentSpec[] = [
  ...
  // Outer ring (A2A peers) — corners. v9 W2b: distinct ElevenLabs voice
  // per peer + longer 12-18 word intros that name the organization + the
  // Google protocol it uses. Producer issues #2 + #3 + #6.
  {
    id: "neighbor_park",
    name: "Neighbor Park · Maasai Mara",
    portrait: "/portraits/neighbor_park.png",
    voiceFile: "/voices/intro-peer-neighbor_park.mp3",
    intro: "Cross-border mutual aid over A2A v0.3. When a poacher crosses my fence, I respond.",
    position: "peer",
    x: 12, y: 14, size: 70,
  },
  {
    id: "sponsor_sustainability",
    name: "Sponsor Sustainability · London",
    portrait: "/portraits/sponsor_sustainability.png",
    voiceFile: "/voices/intro-peer-sponsor_sustainability.mp3",
    intro: "I file CSRD-E4 and TNFD-aligned disclosures to F500 boards over A2A v0.3.",
    position: "peer",
    x: 91, y: 14, size: 70,
  },
  {
    id: "funder_reporter",
    name: "Funder Reporter · Geneva",
    portrait: "/portraits/funder_reporter.png",
    voiceFile: "/voices/intro-peer-funder_reporter.mp3",
    intro: "I issue conservation-impact receipts to philanthropy desks — every dollar linked to a verified incident.",
    position: "peer",
    x: 12, y: 86, size: 70,
  },
  {
    id: "park_service",
    name: "Park Service · Dar es Salaam",
    portrait: "/portraits/park_service.png",
    voiceFile: "/voices/intro-peer-park_service.mp3",
    intro: "I dispatch ranger units over A2A v0.3 within 90 seconds of a verified alert.",
    position: "peer",
    x: 91, y: 86, size: 70,
  },
];
